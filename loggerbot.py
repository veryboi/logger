...
tokenKey = "NDk4ODYwMzI5NTMxMzQyODQ4.Dw77PA.xWaXSyGJjOcHgABLfMccEIMSqb4" #<< Not actual token, just an example.
...
async def on_message(message):
    try:
        ...
        if not(msgContained):
            ...
            await client.send_message(client.get_channel('530221804069978114'), '{1}{2} {3}said: {0}'.format(MsgText,str(message.author.name),Nickname,Status))
